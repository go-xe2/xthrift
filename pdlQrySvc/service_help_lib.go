...
// handler /pdl/help
func (p *TService) help(req *xhttpServer.THttpRequest) {
...
func (p *TService) writeHelpMethods(req *xhttpServer.THttpRequest) {
...
func (p *TService) writeHelpMethod(req *xhttpServer.THttpRequest, route *xhttpServer.THttpRouterInfo) {
...
func (p *TService) writeMethodSep(req *xhttpServer.THttpRequest) {
