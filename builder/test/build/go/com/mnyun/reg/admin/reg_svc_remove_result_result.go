...
type RegSvcRemoveResultResult struct {
...
var _ pdl.DynamicStruct = (*RegSvcRemoveResultResult)(nil)
var _ thrift.TStruct = (*RegSvcRemoveResultResult)(nil)

func NewRegSvcRemoveResultResult() *RegSvcRemoveResultResult {
	inst := &RegSvcRemoveResultResult{
...
func (p *RegSvcRemoveResultResult) init() *RegSvcRemoveResultResult {
	...
	p.fields["Success"] = pdl.NewStructFieldInfo(1, thrift.BOOL, func(obj pdl.DynamicStruct, val interface{}) bool {
		thisObj := obj.(*RegSvcRemoveResultResult)
		b := t.Bool(val)
		thisObj.Success = &b
...
func (p *RegSvcRemoveResultResult) Read(in thrift.TProtocol) error {
...
func (p *RegSvcRemoveResultResult) Write(out thrift.TProtocol) error {
	if err := out.WriteStructBegin("reg_svc_remove_result_result"); err != nil {
		return err
	}
	if p.Success != nil {
...
func (p *RegSvcRemoveResultResult) GetSuccess() bool {
	if p.Success == nil {
		b := false
		p.Success = &b
...
func (p *RegSvcRemoveResultResult) NewInstance() pdl.DynamicStruct {
	return NewRegSvcRemoveResultResult()
}

func (p *RegSvcRemoveResultResult) AllFields() map[string]*pdl.TStructFieldInfo {
	return p.fields
}

func (p *RegSvcRemoveResultResult) FieldNameMaps() map[string]string {
