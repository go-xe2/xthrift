...
type RegSvcGetRegTreeResultResult struct {
...
var _ pdl.DynamicStruct = (*RegSvcGetRegTreeResultResult)(nil)
var _ thrift.TStruct = (*RegSvcGetRegTreeResultResult)(nil)

func NewRegSvcGetRegTreeResultResult() *RegSvcGetRegTreeResultResult {
	inst := &RegSvcGetRegTreeResultResult{
...
func (p *RegSvcGetRegTreeResultResult) init() *RegSvcGetRegTreeResultResult {
	...
	p.fields["Success"] = pdl.NewStructFieldInfo(1, thrift.LIST, func(obj pdl.DynamicStruct, val interface{}) bool {
		thisObj := obj.(*RegSvcGetRegTreeResultResult)
...
func (p *RegSvcGetRegTreeResultResult) Read(in thrift.TProtocol) error {
...
func (p *RegSvcGetRegTreeResultResult) Write(out thrift.TProtocol) error {
	if err := out.WriteStructBegin("reg_svc_get_reg_tree_result_result"); err != nil {
		return err
	}
	if p.Success != nil {
...
func (p *RegSvcGetRegTreeResultResult) GetSuccess() []*types.RegItem {
	if p.Success == nil {
...
func (p *RegSvcGetRegTreeResultResult) NewInstance() pdl.DynamicStruct {
	return NewRegSvcGetRegTreeResultResult()
}

func (p *RegSvcGetRegTreeResultResult) AllFields() map[string]*pdl.TStructFieldInfo {
	return p.fields
}

func (p *RegSvcGetRegTreeResultResult) FieldNameMaps() map[string]string {
