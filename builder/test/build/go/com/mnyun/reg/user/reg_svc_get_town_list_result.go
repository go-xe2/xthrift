...
type RegSvcGetTownListResult struct {
...
var _ pdl.DynamicStruct = (*RegSvcGetTownListResult)(nil)
var _ thrift.TStruct = (*RegSvcGetTownListResult)(nil)

func NewRegSvcGetTownListResult() *RegSvcGetTownListResult {
	inst := &RegSvcGetTownListResult{
...
func (p *RegSvcGetTownListResult) init() *RegSvcGetTownListResult {
	...
	p.fields["Success"] = pdl.NewStructFieldInfo(1, thrift.LIST, func(obj pdl.DynamicStruct, val interface{}) bool {
		thisObj := obj.(*RegSvcGetTownListResult)
...
func (p *RegSvcGetTownListResult) Read(in thrift.TProtocol) error {
...
func (p *RegSvcGetTownListResult) Write(out thrift.TProtocol) error {
	if err := out.WriteStructBegin("reg_svc_get_town_list_result"); err != nil {
		return err
	}
	if p.Success != nil {
...
func (p *RegSvcGetTownListResult) GetSuccess() []*types.RegItem {
	if p.Success == nil {
...
func (p *RegSvcGetTownListResult) NewInstance() pdl.DynamicStruct {
	return NewRegSvcGetTownListResult()
}

func (p *RegSvcGetTownListResult) AllFields() map[string]*pdl.TStructFieldInfo {
	return p.fields
}

func (p *RegSvcGetTownListResult) FieldNameMaps() map[string]string {
