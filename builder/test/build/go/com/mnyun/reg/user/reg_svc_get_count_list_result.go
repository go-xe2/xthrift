...
type RegSvcGetCountListResult struct {
...
var _ pdl.DynamicStruct = (*RegSvcGetCountListResult)(nil)
var _ thrift.TStruct = (*RegSvcGetCountListResult)(nil)

func NewRegSvcGetCountListResult() *RegSvcGetCountListResult {
	inst := &RegSvcGetCountListResult{
...
func (p *RegSvcGetCountListResult) init() *RegSvcGetCountListResult {
	...
	p.fields["Success"] = pdl.NewStructFieldInfo(1, thrift.LIST, func(obj pdl.DynamicStruct, val interface{}) bool {
		thisObj := obj.(*RegSvcGetCountListResult)
...
func (p *RegSvcGetCountListResult) Read(in thrift.TProtocol) error {
...
func (p *RegSvcGetCountListResult) Write(out thrift.TProtocol) error {
	if err := out.WriteStructBegin("reg_svc_get_count_list_result"); err != nil {
		return err
	}
	if p.Success != nil {
...
func (p *RegSvcGetCountListResult) GetSuccess() []*types.RegItem {
	if p.Success == nil {
...
func (p *RegSvcGetCountListResult) NewInstance() pdl.DynamicStruct {
	return NewRegSvcGetCountListResult()
}

func (p *RegSvcGetCountListResult) AllFields() map[string]*pdl.TStructFieldInfo {
	return p.fields
}

func (p *RegSvcGetCountListResult) FieldNameMaps() map[string]string {
